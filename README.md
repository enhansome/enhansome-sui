...
* VSCode Move by Mysten Labs - VSCode Extension supports Move on Sui development with LSP features through Move Analyzer developed by Mysten Labs.
  * [GitHub](https://github.com/MystenLabs/sui/tree/main/external-crates/move/crates/move-analyzer) ⭐ 7,740 | 🐛 822 | 🌐 Rust | 📅 2026-08-28 - [Documentation & Tutorial](https://marketplace.visualstudio.com/items?itemName=mysten.move) - [Further Information](details/ide_vscode_mysten_move_analyzer.md)
...
* [Prettier Move Plugin](https://github.com/MystenLabs/sui/tree/main/external-crates/move/crates/move-analyzer/prettier-plugin) ⭐ 7,740 | 🐛 822 | 🌐 Rust | 📅 2026-08-28 - A Move language plugin for the Prettier code formatter.
* [Tree Sitter Move](https://github.com/MystenLabs/sui/tree/main/external-crates/move/tooling/tree-sitter) ⭐ 7,740 | 🐛 822 | 🌐 Rust | 📅 2026-08-28 - Tree Sitter for Move. [What is tree sitter](https://tree-sitter.github.io/tree-sitter/).
...
* Sui Rust SDK (Mysten Labs) - Rust SDK to interact with Sui Blockchain.
  * [GitHub](https://github.com/MystenLabs/sui/tree/main/crates/sui-sdk) ⭐ 7,740 | 🐛 822 | 🌐 Rust | 📅 2026-08-28 - [Documentation](https://mystenlabs.github.io/sui/sui_sdk/index.html) - [Further Information](details/sdk_sui_rust.md)
...
* [Move on Sui examples (Mysten Labs)](https://github.com/MystenLabs/sui/tree/main/examples/move) ⭐ 7,740 | 🐛 822 | 🌐 Rust | 📅 2026-08-28 - Examples of Move on Sui applications.
...
* [Eliza](https://github.com/elizaOS/eliza) ⭐ 19,197 | 🐛 1,312 | 🌐 TypeScript | 📅 2026-08-28 - Autonomous agents for everyone.
