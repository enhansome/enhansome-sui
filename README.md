...
* VSCode Move by Mysten Labs - VSCode Extension supports Move on Sui development with LSP features through Move Analyzer developed by Mysten Labs.
  * [GitHub](https://github.com/MystenLabs/sui/tree/main/external-crates/move/crates/move-analyzer) ⭐ 7,734 | 🐛 809 | 🌐 Rust | 📅 2026-08-13 - [Documentation & Tutorial](https://marketplace.visualstudio.com/items?itemName=mysten.move) - [Further Information](details/ide_vscode_mysten_move_analyzer.md)
...
* [Prettier Move Plugin](https://github.com/MystenLabs/sui/tree/main/external-crates/move/crates/move-analyzer/prettier-plugin) ⭐ 7,734 | 🐛 809 | 🌐 Rust | 📅 2026-08-13 - A Move language plugin for the Prettier code formatter.
* [Tree Sitter Move](https://github.com/MystenLabs/sui/tree/main/external-crates/move/tooling/tree-sitter) ⭐ 7,734 | 🐛 809 | 🌐 Rust | 📅 2026-08-13 - Tree Sitter for Move. [What is tree sitter](https://tree-sitter.github.io/tree-sitter/).
...
* Sui TypeScript SDK (Mysten Labs) - TypeScript modular library of tools for interacting with the Sui Blockchain.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/typescript) ⭐ 98 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-12 - [Documentation](https://sdk.mystenlabs.com/typescript) - [Further Information](details/sdk_sui_typescript.md)
...
* Sui Rust SDK (Mysten Labs) - Rust SDK to interact with Sui Blockchain.
  * [GitHub](https://github.com/MystenLabs/sui/tree/main/crates/sui-sdk) ⭐ 7,734 | 🐛 809 | 🌐 Rust | 📅 2026-08-13 - [Documentation](https://mystenlabs.github.io/sui/sui_sdk/index.html) - [Further Information](details/sdk_sui_rust.md)
* Pysui - Python SDK to interact with Sui Blockchain.
  * [GitHub](https://github.com/FrankC01/pysui?tab=readme-ov-file) ⭐ 212 | 🐛 6 | 🌐 Python | 📅 2026-08-13 - [Documentation](https://pysui.readthedocs.io/en/latest/index.html) - [Pypi](https://pypi.org/project/pysui/) - [Discord](https://discord.gg/uCGYfY4Ph4) - [Further Information](details/sdk_pysui.md)
...
* [Aftermath SDK](https://github.com/AftermathFinance/aftermath-ts-sdk) ⭐ 28 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-11 - The TypeScript SDK for interacting with Aftermath Protocol.
...
* Sui Wallet Standard (Mysten Labs) - A suite of standard utilities for implementing wallets and libraries based on the [Wallet Standard](https://github.com/wallet-standard/wallet-standard/) ⭐ 360 | 🐛 25 | 🌐 TypeScript | 📅 2026-06-03.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/wallet-standard) ⭐ 98 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-12 - [Documentation](https://docs.sui.io/standards/wallet-standard)
...
* [TypeMove (Sentio)](https://github.com/sentioxyz/typemove/blob/main/packages/sui/Readme.md) ⭐ 53 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-12 - Generate TypeScript bindings for Sui contracts.
...
* Sui dApp Kit (Mysten Labs) - Set of React components, hooks, and utilities to help you build a dApp for the Sui ecosystem.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/dapp-kit) ⭐ 98 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-12 - [Documentation](https://sdk.mystenlabs.com/dapp-kit)
...
* [Move on Sui examples (Mysten Labs)](https://github.com/MystenLabs/sui/tree/main/examples/move) ⭐ 7,734 | 🐛 809 | 🌐 Rust | 📅 2026-08-13 - Examples of Move on Sui applications.
...
* [Eliza](https://github.com/elizaOS/eliza) ⭐ 19,036 | 🐛 410 | 🌐 TypeScript | 📅 2026-08-13 - Autonomous agents for everyone.
