...
* VSCode Move by Mysten Labs - VSCode Extension supports Move on Sui development with LSP features through Move Analyzer developed by Mysten Labs.
  * [GitHub](https://github.com/MystenLabs/sui/tree/main/external-crates/move/crates/move-analyzer) ⭐ 7,737 | 🐛 813 | 🌐 Rust | 📅 2026-08-19 - [Documentation & Tutorial](https://marketplace.visualstudio.com/items?itemName=mysten.move) - [Further Information](details/ide_vscode_mysten_move_analyzer.md)
...
* [Prettier Move Plugin](https://github.com/MystenLabs/sui/tree/main/external-crates/move/crates/move-analyzer/prettier-plugin) ⭐ 7,737 | 🐛 813 | 🌐 Rust | 📅 2026-08-19 - A Move language plugin for the Prettier code formatter.
* [Tree Sitter Move](https://github.com/MystenLabs/sui/tree/main/external-crates/move/tooling/tree-sitter) ⭐ 7,737 | 🐛 813 | 🌐 Rust | 📅 2026-08-19 - Tree Sitter for Move. [What is tree sitter](https://tree-sitter.github.io/tree-sitter/).
* [Sui Extension](https://github.com/zktx-io/sui-extension) ⭐ 8 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-19 - The Sui extension provides seamless support for compiling, deploying, and testing Sui smart contracts directly within VS Code.
...
* Sui TypeScript SDK (Mysten Labs) - TypeScript modular library of tools for interacting with the Sui Blockchain.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/typescript) ⭐ 98 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-18 - [Documentation](https://sdk.mystenlabs.com/typescript) - [Further Information](details/sdk_sui_typescript.md)
* Sui Kit(Scallop) - Toolkit for interacting with the Sui network in TypeScript.
  * [GitHub](https://github.com/scallop-io/sui-kit) ⭐ 188 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-28 - [Further Information](details/sdk_sui_kit_scallop.md)
* Sui Rust SDK (Mysten Labs) - Rust SDK to interact with Sui Blockchain.
  * [GitHub](https://github.com/MystenLabs/sui/tree/main/crates/sui-sdk) ⭐ 7,737 | 🐛 813 | 🌐 Rust | 📅 2026-08-19 - [Documentation](https://mystenlabs.github.io/sui/sui_sdk/index.html) - [Further Information](details/sdk_sui_rust.md)
* Pysui - Python SDK to interact with Sui Blockchain.
  * [GitHub](https://github.com/FrankC01/pysui?tab=readme-ov-file) ⭐ 212 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - [Documentation](https://pysui.readthedocs.io/en/latest/index.html) - [Pypi](https://pypi.org/project/pysui/) - [Discord](https://discord.gg/uCGYfY4Ph4) - [Further Information](details/sdk_pysui.md)
...
* [Scallop SDK](https://github.com/scallop-io/sui-scallop-sdk) ⭐ 56 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - The TypeScript SDK for interacting with the Scallop lending protocol on the Sui network.
...
* [Aftermath SDK](https://github.com/AftermathFinance/aftermath-ts-sdk) ⭐ 28 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-18 - The TypeScript SDK for interacting with Aftermath Protocol.
* [Bucket Protocol SDK](https://github.com/Bucket-Protocol/bucket-protocol-sdk) ⭐ 21 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-18 - The TypeScript SDK for interacting with Bucket Protocol.
...
* Sui Wallet Standard (Mysten Labs) - A suite of standard utilities for implementing wallets and libraries based on the [Wallet Standard](https://github.com/wallet-standard/wallet-standard/) ⭐ 361 | 🐛 25 | 🌐 TypeScript | 📅 2026-06-03.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/wallet-standard) ⭐ 98 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-18 - [Documentation](https://docs.sui.io/standards/wallet-standard)
...
* [TypeMove (Sentio)](https://github.com/sentioxyz/typemove/blob/main/packages/sui/Readme.md) ⭐ 52 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-18 - Generate TypeScript bindings for Sui contracts.
...
* Sui dApp Kit (Mysten Labs) - Set of React components, hooks, and utilities to help you build a dApp for the Sui ecosystem.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/dapp-kit) ⭐ 98 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-18 - [Documentation](https://sdk.mystenlabs.com/dapp-kit)
...
* React ZK Login Kit - Ready-to-use Component with Hook (sign-in + sign-transaction)
  * [GitHub](https://github.com/denyskozak/react-sui-zk-login-kit) ⭐ 37 | 🐛 0 | 🌐 TypeScript | 📅 2025-10-04 - [YouTube Guide](https://www.youtube.com/watch?v=2qnjmKg3ugY)
...
* [Move on Sui examples (Mysten Labs)](https://github.com/MystenLabs/sui/tree/main/examples/move) ⭐ 7,737 | 🐛 813 | 🌐 Rust | 📅 2026-08-19 - Examples of Move on Sui applications.
...
* [Sui Codec](https://github.com/sui-potatoes/app/tree/main/packages/codec) ⭐ 13 | 🐛 2 | 🌐 Move | 📅 2026-06-19 - Ultimate encoding solution for Sui.
...
* [Eliza](https://github.com/elizaOS/eliza) ⭐ 19,096 | 🐛 345 | 🌐 TypeScript | 📅 2026-08-19 - Autonomous agents for everyone.
