...
* VSCode Move by Mysten Labs - VSCode Extension supports Move on Sui development with LSP features through Move Analyzer developed by Mysten Labs.
  * [GitHub](https://github.com/MystenLabs/sui/tree/main/external-crates/move/crates/move-analyzer) ⭐ 7,743 | 🐛 819 | 🌐 Rust | 📅 2026-09-08 - [Documentation & Tutorial](https://marketplace.visualstudio.com/items?itemName=mysten.move) - [Further Information](details/ide_vscode_mysten_move_analyzer.md)
...
* [Prettier Move Plugin](https://github.com/MystenLabs/sui/tree/main/external-crates/move/crates/move-analyzer/prettier-plugin) ⭐ 7,743 | 🐛 819 | 🌐 Rust | 📅 2026-09-08 - A Move language plugin for the Prettier code formatter.
* [Tree Sitter Move](https://github.com/MystenLabs/sui/tree/main/external-crates/move/tooling/tree-sitter) ⭐ 7,743 | 🐛 819 | 🌐 Rust | 📅 2026-09-08 - Tree Sitter for Move. [What is tree sitter](https://tree-sitter.github.io/tree-sitter/).
...
* Sui TypeScript SDK (Mysten Labs) - TypeScript modular library of tools for interacting with the Sui Blockchain.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/typescript) ⭐ 98 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-04 - [Documentation](https://sdk.mystenlabs.com/typescript) - [Further Information](details/sdk_sui_typescript.md)
...
* Sui Rust SDK (Mysten Labs) - Rust SDK to interact with Sui Blockchain.
  * [GitHub](https://github.com/MystenLabs/sui/tree/main/crates/sui-sdk) ⭐ 7,743 | 🐛 819 | 🌐 Rust | 📅 2026-09-08 - [Documentation](https://mystenlabs.github.io/sui/sui_sdk/index.html) - [Further Information](details/sdk_sui_rust.md)
* Pysui - Python SDK to interact with Sui Blockchain.
  * [GitHub](https://github.com/FrankC01/pysui?tab=readme-ov-file) ⭐ 212 | 🐛 3 | 🌐 Python | 📅 2026-09-08 - [Documentation](https://pysui.readthedocs.io/en/latest/index.html) - [Pypi](https://pypi.org/project/pysui/) - [Discord](https://discord.gg/uCGYfY4Ph4) - [Further Information](details/sdk_pysui.md)
...
* Sui Kotlin SDK - Kotlin Multiplatform (KMP) SDK for integrating with the Sui Blockchain.
  * [GitHub](https://github.com/mcxross/ksui) ⭐ 18 | 🐛 4 | 🌐 Kotlin | 📅 2026-08-31 - [Documentation](https://suicookbook.com) - [Further Information](details/sdk_ksui.md)
...
* [Aftermath SDK](https://github.com/AftermathFinance/aftermath-ts-sdk) ⭐ 28 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-05 - The TypeScript SDK for interacting with Aftermath Protocol.
...
* Sui Wallet Standard (Mysten Labs) - A suite of standard utilities for implementing wallets and libraries based on the [Wallet Standard](https://github.com/wallet-standard/wallet-standard/) ⭐ 364 | 🐛 26 | 🌐 TypeScript | 📅 2026-06-03.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/wallet-standard) ⭐ 98 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-04 - [Documentation](https://docs.sui.io/standards/wallet-standard)
...
* [TypeMove (Sentio)](https://github.com/sentioxyz/typemove/blob/main/packages/sui/Readme.md) ⭐ 52 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-05 - Generate TypeScript bindings for Sui contracts.
...
* [Sui Gas Pool (Mysten Labs)](https://github.com/MystenLabs/sui-gas-pool) ⭐ 39 | 🐛 3 | 🌐 Rust | 📅 2026-09-08 - Service that powers sponsored transactions on Sui at scale.
...
* Sui dApp Kit (Mysten Labs) - Set of React components, hooks, and utilities to help you build a dApp for the Sui ecosystem.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/dapp-kit) ⭐ 98 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-04 - [Documentation](https://sdk.mystenlabs.com/dapp-kit)
...
* [Move on Sui examples (Mysten Labs)](https://github.com/MystenLabs/sui/tree/main/examples/move) ⭐ 7,743 | 🐛 819 | 🌐 Rust | 📅 2026-09-08 - Examples of Move on Sui applications.
...
* [Eliza](https://github.com/elizaOS/eliza) ⭐ 19,295 | 🐛 1,275 | 🌐 TypeScript | 📅 2026-09-08 - Autonomous agents for everyone.
