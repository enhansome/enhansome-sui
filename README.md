...
* VSCode Move by Mysten Labs - VSCode Extension supports Move on Sui development with LSP features through Move Analyzer developed by Mysten Labs.
  * [GitHub](https://github.com/MystenLabs/sui/tree/main/external-crates/move/crates/move-analyzer) ⭐ 7,754 | 🐛 853 | 🌐 Rust | 📅 2026-09-22 - [Documentation & Tutorial](https://marketplace.visualstudio.com/items?itemName=mysten.move) - [Further Information](details/ide_vscode_mysten_move_analyzer.md)
...
* [Prettier Move Plugin](https://github.com/MystenLabs/sui/tree/main/external-crates/move/crates/move-analyzer/prettier-plugin) ⭐ 7,754 | 🐛 853 | 🌐 Rust | 📅 2026-09-22 - A Move language plugin for the Prettier code formatter.
* [Tree Sitter Move](https://github.com/MystenLabs/sui/tree/main/external-crates/move/tooling/tree-sitter) ⭐ 7,754 | 🐛 853 | 🌐 Rust | 📅 2026-09-22 - Tree Sitter for Move. [What is tree sitter](https://tree-sitter.github.io/tree-sitter/).
...
* Sui TypeScript SDK (Mysten Labs) - TypeScript modular library of tools for interacting with the Sui Blockchain.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/sui) ⭐ 98 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-21 - [Documentation](https://sdk.mystenlabs.com/typescript) - [Further Information](details/sdk_sui_typescript.md)
...
* Sui Rust SDK (Mysten Labs) - Rust SDK to interact with Sui Blockchain.
  * [GitHub](https://github.com/MystenLabs/sui/tree/main/crates/sui-sdk) ⭐ 7,754 | 🐛 853 | 🌐 Rust | 📅 2026-09-22 - [Documentation](https://mystenlabs.github.io/sui/sui_sdk/index.html) - [Further Information](details/sdk_sui_rust.md)
...
* Sui Go SDK (SuiVision) - Golang SDK to interact with Sui Blockchain.
  * [GitHub](https://github.com/block-vision/sui-go-sdk) ⭐ 198 | 🐛 15 | 🌐 Go | 📅 2026-09-18 - [API Documentation](https://pkg.go.dev/github.com/block-vision/sui-go-sdk) - [Examples](https://github.com/block-vision/sui-go-sdk?tab=readme-ov-file#examples) ⭐ 198 | 🐛 15 | 🌐 Go | 📅 2026-09-18 - [Further Information](details/sdk_sui_go.md)
...
* Sui Kotlin SDK - Kotlin Multiplatform (KMP) SDK for integrating with the Sui Blockchain.
  * [GitHub](https://github.com/mcxross/ksui) ⭐ 18 | 🐛 1 | 🌐 Kotlin | 📅 2026-09-10 - [Documentation](https://suicookbook.com) - [Further Information](details/sdk_ksui.md)
...
* [Aftermath SDK](https://github.com/AftermathFinance/aftermath-ts-sdk) ⭐ 28 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-22 - The TypeScript SDK for interacting with Aftermath Protocol.
...
* Sui Wallet Standard (Mysten Labs) - A suite of standard utilities for implementing wallets and libraries based on the [Wallet Standard](https://github.com/wallet-standard/wallet-standard/) ⭐ 367 | 🐛 24 | 🌐 TypeScript | 📅 2026-06-03.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/wallet-standard) ⭐ 98 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-21 - [Documentation](https://docs.sui.io/standards/wallet-standard)
* [Sui Client Gen (Kuna Labs)](https://github.com/kunalabs-io/sui-client-gen/tree/master) ⭐ 103 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-26 - A tool for generating TS SDKs for Sui Move smart contracts. Supports code generation both for source code and on-chain packages with no IDLs or ABIs required.
* [TypeMove (Sentio)](https://github.com/sentioxyz/typemove/blob/main/packages/sui/Readme.md) ⭐ 52 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-20 - Generate TypeScript bindings for Sui contracts.
...
* [Sui APIs (Mysten Labs)](https://github.com/MystenLabs/sui-apis) ⭐ 16 | 🐛 3 | 🌐 Makefile | 📅 2026-09-21 - Public Sui gRPC interface definitions for generating client libraries, documentation, and other artifacts.
...
* [Sui dApp Scaffold (Bucket Protocol)](https://github.com/Bucket-Protocol/sui-dapp-scaffold-v1) ⭐ 29 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-11 - A frontend scaffold for a decentralized application (dApp) on the Sui Blockchain.
...
* Sui dApp Kit (Mysten Labs) - Set of React components, hooks, and utilities to help you build a dApp for the Sui ecosystem.
  * [GitHub](https://github.com/MystenLabs/ts-sdks/tree/main/packages/dapp-kit) ⭐ 98 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-21 - [Documentation](https://sdk.mystenlabs.com/dapp-kit)
...
* Suiet Wallet Kit - React toolkit for aApps to interact with all wallet types in Sui easily.
  * [GitHub](https://github.com/suiet/wallet-kit) ⚠️ Archived - [Documentation](https://kit.suiet.app/docs/QuickStart)
...
* SuiBase - Suibase makes it easy to create "workdirs", each defining a distinct development environment targeting a network.
  * [GitHub](https://github.com/chainmovers/suibase) ⭐ 50 | 🐛 15 | 🌐 Rust | 📅 2026-08-07 - [Documentation](https://suibase.io/)
...
* [Move on Sui examples (Mysten Labs)](https://github.com/MystenLabs/sui/tree/main/examples/move) ⭐ 7,754 | 🐛 853 | 🌐 Rust | 📅 2026-09-22 - Examples of Move on Sui applications.
...
* [Cetus CLMM](https://github.com/CetusProtocol/cetus-contracts/tree/main/packages/cetus_clmm) ⭐ 30 | 🐛 0 | 🌐 Move | 📅 2026-09-18 - The Cetus CLMM DEX open-source code.
...
* [Eliza](https://github.com/elizaOS/eliza) ⭐ 19,403 | 🐛 1,492 | 🌐 TypeScript | 📅 2026-09-22 - Autonomous agents for everyone.
* [Mysten Labs Agent Skills](https://github.com/MystenLabs/skills) ⭐ 14 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-21 - Reusable agent skills for building on Sui with Claude Code, Cursor, Codex, and other AI coding agents.
